...
<body>
    ...
    <br>
    <h1 class="text-white text-center font-weight-bold bg-warning"  style="background-color: #28a782!important;style="font-size: 55px;"> New Vehicle Registration </h1>
    <div class="container"style="background-color:#ffc1071f; "><br>
        <div class="col-lg-6 m-auto d-block"style="color: #007bff;" >
            <form method="POST" onsubmit="return validation()" class="bg-light"style="background-color:#90EE90;!important">
                <div class="form-group">
					<label for="tempNo" class="font-weight-bold"> Temporary Password: </label>
